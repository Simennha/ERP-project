...
// --- Fetch plumbing ----------------------------------------------------------
// authedFetch is shared (lib/auth/api-client.ts) — it handles the fetch
// pattern below plus a silent 401 -> refresh -> retry recovery every module
// used to lack. buildQuery stays module-local (trivial, not auth-related).
